 ...
 * https://modernizr.com/download/?-hashchange-history-printshiv-setclasses !*/
...
var site = (function() {
    ...
    var menuBurger = function() {
        ...
        var $burger = $('.navmenu-trigger');
        var $bearnav = $('.navigation-menu');
        var $links = $bearnav.find('.menulist--item a');
        ...
        $links.on('mouseover',function(e){
            $(this).addClass('itemhoverd');
 $(this).parent().siblings().find('a').removeClass('itemhoverd');
            $bearnav.addClass('hovered');
        })
       
 $links.on('mouseout',function(e){
      $(this).removeClass('itemhoverd');
       $bearnav.removeClass('hovered');
 })
        // on click burger
        ...
        // on click close
        $bearnav.find('.navmenu-close').on('click', menuHide);

        // show
        function menuShow() {
            deployed = true;
            $('html').addClass('menu--deployed menu--active');
$bearnav.slideDown("slow");
            $('.nav-item-vertical').fadeIn('slow');
            // Animation
...
$bearnav.slideUp("slow");
            $('.nav-item-vertical').fadeOut('slow');
            // Animation
            var tl = new TimelineLite();
            tl.pause();
            tl.staggerFromTo(
    ...
    */
    ...
    var pageInit = function() {
        ...
        */
        ...
        $.get("/wp-content/plugins/contact-form-7/includes/js/scripts.js?ver=4.1.1");*/
    ...
    var initScrollAnimations = function() {
        ...
        $('.page-container:first .scroll-reveal').each(function() {
            ...
            scene.on('start', function(e) {
               ...
               // if (e.scrollDirection != 'REVERSE' && !$('html').hasClass('prehome-active')) { // modified
...
//            tl.to(
//                element.find('.maintitle--introtext > .animate-bg'),
//                0.4,
//                {
//                    y: '0%',
//                    ease: Power3.easeOut
...
//            );
            ...
            tl.to(
                element.find('.maintitle--introtext > .animate-text'),
                0.4,
                {
                    y: '-0%',
                    alpha:1,
...
//            tl.to(
//                element.find('.maintitle--text > .animate-bg'),
//                0.4,
//                {
//                    y: '0%',
//                    ease: Power3.easeOut
...
//            );
            ...
            tl.to(
                element.find('.maintitle--text > .animate-text'),
                0.8,
                {
                    y: '0',
                    alpha:1,
...
//            tl.to(
//                element.find('.maintitle--subtext > .animate-bg'),
//                0.4,
//                {
//                    y: '0%',
//                    ease: Power3.easeOut
...
//            );
            ...
            tl.to(
                element.find('.maintitle--subtext > .animate-text'),
                0.8,
                {
                    y: '0',
                    alpha:1,
             ...
             tl.to(
                element.find('.maintitle--button > .btn-animate'),
                0.8,
                {
                    y: '0',
                    alpha:1,
            ...
            tl.to(
                element.find('.maintitle--button > .btn-scale-animate-wrap'),
                0.8,
                {
                    y: '0',
                    alpha:1,
...
//            tl.to(
//                element.find('.btn-animate > .animate-bg'),
//                0.5,
//                {
//                    x: '0%',
//                    width:'50px',
...
//            );
            ...
            tl.pause();
 tl.to(
                element.find('.animatefadeLeftPic'),
                2,
                {
                    x: '0%',
                     alpha:1,
                    ease: Power3.easeOut
                   // ease: new Ease(BezierEasing(0.25, 0.1, 0.0, 1.0))
                },
                0
            );
     tl.from(
                element.find('.animatefadeLeftPic > .img-wrap'),
                0.8,
                {
                    x: '90%',
                     alpha:1,
    ...
    tl.to(
                element.find('.animatefadeLeftPic1'),
                1,
                {
                    x: '0%',
                    alpha:1,
...
//      tl.from(
//                element.find('.animatefadeLeftPic1 > .img-wrap'),
//                0.8,
//                {
//                    x: '90%',
//                     alpha:1,
...
//            );
    ...
    tl.to(
                element.find('.animatefadeLeftPic2'),
                1,
                {
                    x: '0%',
                    alpha:1,
...
//     tl.from(
//                element.find('.animatefadeLeftPic2 > .img-wrap'),
//                0.8,
//                {
//                    x: '90%',
//                     alpha:1,
...
//    
    ...
    tl.to(
                element.find('.animatefadeLeftPic3'),
                1,
                {
                    x: '0%',
                    alpha:1,
      ...
      tl.to(
                element.find('.villafadeLeftPic1'),
                0.8,
                {
                    x: '0%',
                    alpha:1,
       ...
       tl.to(
                element.find('.villafadeLeftPic2'),
                0.8,
                {
                    x: '0%',
                    alpha:1,
...
//     tl.from(
//                element.find('.animatefadeLeftPic3 > .img-wrap'),
//                0.8,
//                {
//                    x: '90%',
//                     alpha:1,
...
//            );
        ...
        else if (element.is('.fadeSec-adjst')) {
...
//            );   
        ...
        else if (element.is(".card--link")) {
              element.addClass('is-revealed');
                        var l, c = .25 * Math.random();
                        (l = new TimelineLite).from(element.find(".card--bg1"), 1, {
                            x: "-100%",
                            ease: Power2.easeOut,
                            clearProps: "all"
                        }, .35 ), l.from(element.find(".card--bg-inner1"), 1, {
                            x: "80%",
                            ease: Power2.easeOut,
                            clearProps: "all"
                        }, .35), l.from(element.find(".card--bg2"), 1, {
                            x: "-100%",
                            ease: Power2.easeOut,
                            clearProps: "all"
                        }, .50), l.from(element.find(".card--bg-inner2"), 1, {
                            x: "80%",
                            ease: Power2.easeOut,
                            clearProps: "all"
                        }, .50), l.from(element.find(".card--bg3"), 1, {
                            x: "-100%",
                            ease: Power2.easeOut,
                            clearProps: "all"
                        }, .65), l.from(element.find(".card--bg-inner3"), 1, {
                            x: "80%",
                            ease: Power2.easeOut,
                            clearProps: "all"
                        }, .65),l.to(element.find('.card--text--primary'),
                0.4,
                {
                    y: '0%',
                    alpha:1,
                ...
                0.8),l.to(element.find('.card--text--secondary'),
                0.4,
                {
                    y: '0%',
                    alpha:1,
                ...
                0.95),l.to(element.find('.card--text--tertiary'),
                0.4,
                {
                    y: '0%',
                    alpha:1,
...
else if (element.is('.buttonanimate')) {
    ...
    tl.to(
        ...
        }else if (element.is('.arrowsAnimate')) {
    ...
    tl.to(
        ...
        }else if (element.is('.header-wrapper')) {
        ...
        else if (element.is('.line-animation')) {
            ...
            tl.to(
                element.find('.right-line'),
                1,
                {
                    css:{height:"100%",transform:'translateY(0)',opacity:1},
                    y: '0%',
                    alpha:1,
                    ease: Power3.easeOut,
...
else if (element.is('.imgoverlays')) {
            ...
            tl.to(
                element.find('.destinationitem--figure .destinationitem--figure--img1'),
                0.8,
                {
                    x: '0%',
                    alpha:1,
    ...
    tl.to(
                element.find('.destinationitem--figure .destinationitem--figure--img2'),
                0.8,
                {
                    x: '0%',
                    alpha:1,
     ...
     tl.to(
                element.find('.destinationitem--figure .destinationitem--figure--img3'),
                0.8,
                {
                    x: '0%',
                    alpha:1,
    ...
    tl.to(
                element.find('.destinationitem--figure .destinationitem--figure--img4'),
                0.8,
                {
                    x: '0%',
                    alpha:1,
        ...
        tl.to(
                element.find('.destinationitem--overlay1'),
                1,
                {
                    x: '0%',
                    ease: Power3.easeOut
    ...
    tl.to(
                element.find('.destinationitem--overlay2'),
               1,
                {
                    x: '0%',
                    ease: Power3.easeOut
    ...
    tl.to(
                element.find('.destinationitem--overlay3'),
                1,
                {
                    x: '0%',
                    ease: Power3.easeOut
    ...
    tl.to(
                element.find('.destinationitem--overlay4'),
                1,
                {
                    x: '0%',
                    ease: Power3.easeOut
    ...
    tl.to(
        ...
        tl.to(
                element.find('.destinationitem--text'),
                0.4,
                {
                    y: '0%',
                    alpha:1,
     ...
     tl.to(
                element.find('.destinationitem--text-secondary'),
                0.4,
                {
                    y: '0%',
                    alpha:1,
                ...
                element.find('.destinationitem--text-tertiary'),
                0.4,
                {
                    y: '0%',
                    alpha:1,
...
else if (element.is('.banner-header')) {
    ...
    tl.to(
                element.find('.banner-header--animatewrap .animate-arrow'),
                0.8,
                {
                    y: '0',
                    alpha:1,
    ...
    tl.to(
                element.find('.banner-header--animatewrap .animate-main-text'),
                0.8,
                {
                    y: '0',
                    alpha:1,
    ...
    tl.to(
                element.find('.banner-header--animatewrap .animate-sub-text'),
               0.8,
                {
                    y: '0',
                    alpha:1,
    ...
    tl.to(
                element.find('.banner-header--animatewrap .animate-form'),
               0.8,
                {
                    y: '0',
                    alpha:1,
    ...
    tl.to(
                element.find('.banner-header--animatewrap .animate-form-text'),
               0.8,
                {
                    y: '0',
                    alpha:1,
